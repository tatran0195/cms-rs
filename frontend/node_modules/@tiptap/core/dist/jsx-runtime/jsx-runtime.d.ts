...
declare const jsxDEV: (tag: Parameters<JSXRenderer>[0], attributes?: Attributes, _key?: unknown, isStaticChildren?: boolean) => 0 | any[] | Attributes;

export { type Attributes, type DOMOutputSpecArray, type DOMOutputSpecElement, Fragment, JSX, type JSXRenderer, h as createElement, h, h as jsx, jsxDEV, jsxs };
