...
function keepCursorInTable(tr, tablePos) {
  ...
  const stillInTable = (0, import_core2.findParentNodeClosestToPos)(
    tr.selection.$from,
...
// src/table/table.ts
var Table = import_core3.Node.create({
  name: "table",
  // @ts-ignore
  addOptions() {
    return {
  ...
  addCommands() {
    return {
      ...
      deleteColumn: () => ({ state, dispatch }) => {
        const table = (0, import_core3.findParentNodeClosestToPos)(
  ...
  addNodeView() {
    ...
    return ({ node, view, HTMLAttributes }) => {
      const mergedAttributes = (0, import_core3.mergeAttributes)(this.options.HTMLAttributes, HTMLAttributes);
  ...
  extendNodeSchema(extension) {
    ...
    return {
      tableRole: (0, import_core3.callOrReturn)((0, import_core3.getExtensionField)(extension, "tableRole", context))
    };
  }
});
