 ...
 */
export declare const getAsyncApiRequiredSecurity: (document: AsyncApiDocument, operation: AsyncApiOperationObject | null | undefined) => RequiredSecurity;
//# sourceMappingURL=get-async-api-required-security.d.ts.map