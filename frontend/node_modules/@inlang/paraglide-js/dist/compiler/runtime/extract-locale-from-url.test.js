...
test("default pattern is case-insensitive but custom urlPatterns keep exact matching", async () => {
    ...
    expect(defaultRuntime.extractLocaleFromUrl("https://example.com/DE/about")).toBe("de");
    ...
    expect(customRuntime.extractLocaleFromUrl("https://example.com/de/about")).toBe("de");
    expect(customRuntime.extractLocaleFromUrl("https://example.com/en/about")).toBe("en");
    expect(customRuntime.extractLocaleFromUrl("https://example.com/DE/about")).toBe(undefined);
});
//# sourceMappingURL=extract-locale-from-url.test.js.map