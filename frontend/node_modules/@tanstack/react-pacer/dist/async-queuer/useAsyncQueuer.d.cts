...
interface ReactAsyncQueuerOptions<TValue, TSelected = {}> extends AsyncQueuerOptions<TValue> {
  /**
 ...
 * ```
 */
declare function useAsyncQueuer<TValue, TSelected = {}>(fn: (value: TValue) => Promise<any>, options?: ReactAsyncQueuerOptions<TValue, TSelected>, selector?: (state: AsyncQueuerState<TValue>) => TSelected): ReactAsyncQueuer<TValue, TSelected>;
//#endregion
export { ReactAsyncQueuer, ReactAsyncQueuerOptions, useAsyncQueuer };
