import { ReactAsyncQueuer, ReactAsyncQueuerOptions } from "./useAsyncQueuer.cjs";
import { AsyncQueuerState } from "@tanstack/pacer/async-queuer";
 ...
 * ```
 */
declare function useAsyncQueuedState<TValue, TSelected extends Pick<AsyncQueuerState<TValue>, 'items'> = Pick<AsyncQueuerState<TValue>, 'items'>>(fn: (value: TValue) => Promise<any>, options?: ReactAsyncQueuerOptions<TValue, TSelected>, selector?: (state: AsyncQueuerState<TValue>) => TSelected): [Array<TValue>, ReactAsyncQueuer<TValue, TSelected>];
//#endregion
