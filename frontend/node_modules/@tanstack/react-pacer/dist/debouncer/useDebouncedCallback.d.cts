import { ReactDebouncerOptions } from "./useDebouncer.cjs";
 ...
 * ```
 */
declare function useDebouncedCallback<TFn extends AnyFunction>(fn: TFn, options: ReactDebouncerOptions<TFn, {}>): (...args: Parameters<TFn>) => void;
//#endregion
