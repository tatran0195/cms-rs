...
interface ReactDebouncerOptions<TFn extends AnyFunction, TSelected = {}> extends DebouncerOptions<TFn> {
  /**
 ...
 * ```
 */
declare function useDebouncer<TFn extends AnyFunction, TSelected = {}>(fn: TFn, options: ReactDebouncerOptions<TFn, TSelected>, selector?: (state: DebouncerState<TFn>) => TSelected): ReactDebouncer<TFn, TSelected>;
//#endregion
export { ReactDebouncer, ReactDebouncerOptions, useDebouncer };
