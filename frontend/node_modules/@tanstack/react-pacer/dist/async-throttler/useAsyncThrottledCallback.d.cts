import { ReactAsyncThrottlerOptions } from "./useAsyncThrottler.cjs";
 ...
 * ```
 */
declare function useAsyncThrottledCallback<TFn extends AnyAsyncFunction>(fn: TFn, options: ReactAsyncThrottlerOptions<TFn, {}>): (...args: Parameters<TFn>) => Promise<Awaited<ReturnType<TFn>> | undefined>;
//#endregion
