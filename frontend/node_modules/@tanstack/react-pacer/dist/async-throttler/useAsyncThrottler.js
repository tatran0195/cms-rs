...
function useAsyncThrottler(fn, options, selector = () => ({})) {
	...
	const [asyncThrottler] = useState(() => {
		...
		asyncThrottlerInstance.Subscribe = function Subscribe(props) {
			const selected = useSelector(asyncThrottlerInstance.store, props.selector, { compare: shallow });
	...
	const state = useSelector(asyncThrottler.store, selector, { compare: shallow });
	useEffect(() => {
		return () => {
