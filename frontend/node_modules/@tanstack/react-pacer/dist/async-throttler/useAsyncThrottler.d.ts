...
interface ReactAsyncThrottlerOptions<TFn extends AnyAsyncFunction, TSelected = {}> extends AsyncThrottlerOptions<TFn> {
  /**
 ...
 * ```
 */
declare function useAsyncThrottler<TFn extends AnyAsyncFunction, TSelected = {}>(fn: TFn, options: ReactAsyncThrottlerOptions<TFn, TSelected>, selector?: (state: AsyncThrottlerState<TFn>) => TSelected): ReactAsyncThrottler<TFn, TSelected>;
//#endregion
export { ReactAsyncThrottler, ReactAsyncThrottlerOptions, useAsyncThrottler };
