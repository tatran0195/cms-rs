...
interface ReactQueuerOptions<TValue, TSelected = {}> extends QueuerOptions<TValue> {
  /**
 ...
 * ```
 */
declare function useQueuer<TValue, TSelected = {}>(fn: (item: TValue) => void, options?: ReactQueuerOptions<TValue, TSelected>, selector?: (state: QueuerState<TValue>) => TSelected): ReactQueuer<TValue, TSelected>;
//#endregion
export { ReactQueuer, ReactQueuerOptions, useQueuer };
