import { ReactAsyncBatcherOptions } from "./useAsyncBatcher.cjs";
 ...
 * ```
 */
declare function useAsyncBatchedCallback<TValue>(fn: (items: Array<TValue>) => Promise<unknown>, options: ReactAsyncBatcherOptions<TValue, {}>): (item: TValue) => Promise<void>;
//#endregion
