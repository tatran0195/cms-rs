...
interface ReactAsyncBatcherOptions<TValue, TSelected = {}> extends AsyncBatcherOptions<TValue> {
  /**
 ...
 * ```
 */
declare function useAsyncBatcher<TValue, TSelected = {}>(fn: (items: Array<TValue>) => Promise<any>, options?: ReactAsyncBatcherOptions<TValue, TSelected>, selector?: (state: AsyncBatcherState<TValue>) => TSelected): ReactAsyncBatcher<TValue, TSelected>;
//#endregion
export { ReactAsyncBatcher, ReactAsyncBatcherOptions, useAsyncBatcher };
