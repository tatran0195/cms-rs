import { ReactAsyncRateLimiterOptions } from "./useAsyncRateLimiter.cjs";
 ...
 * ```
 */
declare function useAsyncRateLimitedCallback<TFn extends AnyAsyncFunction>(fn: TFn, options: ReactAsyncRateLimiterOptions<TFn, {}>): (...args: Parameters<TFn>) => Promise<Awaited<ReturnType<TFn>> | undefined>;
//#endregion
