...
interface ReactAsyncRateLimiterOptions<TFn extends AnyAsyncFunction, TSelected = {}> extends AsyncRateLimiterOptions<TFn> {
  /**
 ...
 * ```
 */
declare function useAsyncRateLimiter<TFn extends AnyAsyncFunction, TSelected = {}>(fn: TFn, options: ReactAsyncRateLimiterOptions<TFn, TSelected>, selector?: (state: AsyncRateLimiterState<TFn>) => TSelected): ReactAsyncRateLimiter<TFn, TSelected>;
//#endregion
export { ReactAsyncRateLimiter, ReactAsyncRateLimiterOptions, useAsyncRateLimiter };
