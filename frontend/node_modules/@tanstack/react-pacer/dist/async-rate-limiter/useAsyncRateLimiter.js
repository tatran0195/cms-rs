...
function useAsyncRateLimiter(fn, options, selector = () => ({})) {
	...
	const [asyncRateLimiter] = useState(() => {
		...
		asyncRateLimiterInstance.Subscribe = function Subscribe(props) {
			const selected = useSelector(asyncRateLimiterInstance.store, props.selector, { compare: shallow });
	...
	const state = useSelector(asyncRateLimiter.store, selector, { compare: shallow });
	return useMemo(() => ({
		...asyncRateLimiter,
		state
