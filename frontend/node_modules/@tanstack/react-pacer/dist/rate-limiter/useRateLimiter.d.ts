...
interface ReactRateLimiterOptions<TFn extends AnyFunction, TSelected = {}> extends RateLimiterOptions<TFn> {
  /**
 ...
 * ```
 */
declare function useRateLimiter<TFn extends AnyFunction, TSelected = {}>(fn: TFn, options: ReactRateLimiterOptions<TFn, TSelected>, selector?: (state: RateLimiterState) => TSelected): ReactRateLimiter<TFn, TSelected>;
//#endregion
export { ReactRateLimiter, ReactRateLimiterOptions, useRateLimiter };
