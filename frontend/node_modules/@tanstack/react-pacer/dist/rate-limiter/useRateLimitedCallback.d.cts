import { ReactRateLimiterOptions } from "./useRateLimiter.cjs";
 ...
 * ```
 */
declare function useRateLimitedCallback<TFn extends AnyFunction>(fn: TFn, options: ReactRateLimiterOptions<TFn, {}>): (...args: Parameters<TFn>) => boolean;
//#endregion
