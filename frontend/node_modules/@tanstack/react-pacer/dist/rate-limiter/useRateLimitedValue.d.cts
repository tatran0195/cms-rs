import { ReactRateLimiter, ReactRateLimiterOptions } from "./useRateLimiter.cjs";
 ...
 * ```
 */
declare function useRateLimitedValue<TValue, TSelected = RateLimiterState>(value: TValue, options: ReactRateLimiterOptions<React.Dispatch<React.SetStateAction<TValue>>, TSelected>, selector?: (state: RateLimiterState) => TSelected): [TValue, ReactRateLimiter<React.Dispatch<React.SetStateAction<TValue>>, TSelected>];
//#endregion
