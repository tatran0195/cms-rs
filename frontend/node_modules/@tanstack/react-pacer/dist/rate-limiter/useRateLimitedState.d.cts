 ...
 * ```
 */
declare function useRateLimitedState<TValue, TSelected = RateLimiterState>(value: TValue, options: ReactRateLimiterOptions<React.Dispatch<React.SetStateAction<TValue>>, TSelected>, selector?: (state: RateLimiterState) => TSelected): [TValue, React.Dispatch<React.SetStateAction<TValue>>, ReactRateLimiter<React.Dispatch<React.SetStateAction<TValue>>, TSelected>];
//#endregion
