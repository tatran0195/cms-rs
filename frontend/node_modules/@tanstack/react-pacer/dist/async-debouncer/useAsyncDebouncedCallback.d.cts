import { ReactAsyncDebouncerOptions } from "./useAsyncDebouncer.cjs";
 ...
 * ```
 */
declare function useAsyncDebouncedCallback<TFn extends AnyAsyncFunction>(fn: TFn, options: ReactAsyncDebouncerOptions<TFn, {}>): (...args: Parameters<TFn>) => Promise<Awaited<ReturnType<TFn>> | undefined>;
//#endregion
