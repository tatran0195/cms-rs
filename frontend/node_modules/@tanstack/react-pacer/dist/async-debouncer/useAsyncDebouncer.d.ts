...
interface ReactAsyncDebouncerOptions<TFn extends AnyAsyncFunction, TSelected = {}> extends AsyncDebouncerOptions<TFn> {
  /**
 ...
 * ```
 */
declare function useAsyncDebouncer<TFn extends AnyAsyncFunction, TSelected = {}>(fn: TFn, options: ReactAsyncDebouncerOptions<TFn, TSelected>, selector?: (state: AsyncDebouncerState<TFn>) => TSelected): ReactAsyncDebouncer<TFn, TSelected>;
//#endregion
export { ReactAsyncDebouncer, ReactAsyncDebouncerOptions, useAsyncDebouncer };
