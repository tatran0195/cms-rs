...
function useAsyncDebouncer(fn, options, selector = () => ({})) {
	...
	const [asyncDebouncer] = useState(() => {
		...
		asyncDebouncerInstance.Subscribe = function Subscribe(props) {
			const selected = useSelector(asyncDebouncerInstance.store, props.selector, { compare: shallow });
	...
	const state = useSelector(asyncDebouncer.store, selector, { compare: shallow });
	useEffect(() => {
		return () => {
