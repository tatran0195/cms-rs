...
function useAsyncDebouncer(fn, options, selector = () => ({})) {
	...
	const [asyncDebouncer] = (0, react.useState)(() => {
		...
		asyncDebouncerInstance.Subscribe = function Subscribe(props) {
			const selected = (0, _tanstack_react_store.useSelector)(asyncDebouncerInstance.store, props.selector, { compare: _tanstack_react_store.shallow });
	...
	const state = (0, _tanstack_react_store.useSelector)(asyncDebouncer.store, selector, { compare: _tanstack_react_store.shallow });
	(0, react.useEffect)(() => {
		return () => {
			if (mergedOptions.onUnmount) mergedOptions.onUnmount(asyncDebouncer);
			else {
