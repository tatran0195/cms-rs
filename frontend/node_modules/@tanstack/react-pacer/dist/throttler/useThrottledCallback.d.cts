import { ReactThrottlerOptions } from "./useThrottler.cjs";
 ...
 * ```
 */
declare function useThrottledCallback<TFn extends AnyFunction>(fn: TFn, options: ReactThrottlerOptions<TFn, {}>): (...args: Parameters<TFn>) => void;
//#endregion
