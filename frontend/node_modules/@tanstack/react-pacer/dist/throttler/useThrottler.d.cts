...
interface ReactThrottlerOptions<TFn extends AnyFunction, TSelected = {}> extends ThrottlerOptions<TFn> {
  /**
 ...
 * ```
 */
declare function useThrottler<TFn extends AnyFunction, TSelected = {}>(fn: TFn, options: ReactThrottlerOptions<TFn, TSelected>, selector?: (state: ThrottlerState<TFn>) => TSelected): ReactThrottler<TFn, TSelected>;
//#endregion
export { ReactThrottler, ReactThrottlerOptions, useThrottler };
