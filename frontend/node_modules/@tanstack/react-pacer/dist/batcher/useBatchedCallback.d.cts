import { ReactBatcherOptions } from "./useBatcher.cjs";
 ...
 * ```
 */
declare function useBatchedCallback<TValue>(fn: (items: Array<TValue>) => void, options: ReactBatcherOptions<TValue, {}>): (item: TValue) => void;
//#endregion
