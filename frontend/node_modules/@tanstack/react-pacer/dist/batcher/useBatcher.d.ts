...
interface ReactBatcherOptions<TValue, TSelected = {}> extends BatcherOptions<TValue> {
  /**
 ...
 * ```
 */
declare function useBatcher<TValue, TSelected = {}>(fn: (items: Array<TValue>) => void, options?: ReactBatcherOptions<TValue, TSelected>, selector?: (state: BatcherState<TValue>) => TSelected): ReactBatcher<TValue, TSelected>;
//#endregion
export { ReactBatcher, ReactBatcherOptions, useBatcher };
