...
interface AsyncRateLimiterOptions<TFn extends AnyAsyncFunction> {
   ...
   * Optional function to call when the rate-limited function is executed
   */
  onSuccess?: (result: Awaited<ReturnType<TFn>>, args: Parameters<TFn>, rateLimiter: AsyncRateLimiter<TFn>) => void;
  /**
 ...
 * ```
 */
declare function asyncRateLimit<TFn extends AnyAsyncFunction>(fn: TFn, initialOptions: AsyncRateLimiterOptions<TFn>): (...args: Parameters<TFn>) => Promise<Awaited<ReturnType<TFn>> | undefined>;
//#endregion
