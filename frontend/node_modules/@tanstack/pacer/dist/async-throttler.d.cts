...
interface AsyncThrottlerOptions<TFn extends AnyAsyncFunction> {
   ...
   * Optional function to call when the throttled function is executed
   */
  onSuccess?: (result: Awaited<ReturnType<TFn>>, args: Parameters<TFn>, asyncThrottler: AsyncThrottler<TFn>) => void;
  /**
 ...
 * ```
 */
declare function asyncThrottle<TFn extends AnyAsyncFunction>(fn: TFn, initialOptions: AsyncThrottlerOptions<TFn>): (...args: Parameters<TFn>) => Promise<Awaited<ReturnType<TFn>> | undefined>;
//#endregion
