...
function useArabicT() {
  ...
  return useCallback<T>(
    (key, variables) =>
      locale === "ar" ? t(key, variables) : translateFn(key, variables, "ar"),
    [locale, t],
  );
}
  ...
  return [
    {
      ...
      sources: [
        ...
        {
          href: "https://github.com/lord007tn/cms",
          label: t("marketing.arabicSeo.source.public"),
        },
      ],
      summary: t("marketing.arabicSeo.platform.cms.summary"),
      bestFor: t("marketing.arabicSeo.platform.cms.bestFor"),
      arabic: t("marketing.arabicSeo.platform.cms.arabic"),
      model: t("marketing.arabicSeo.platform.cms.model"),
      caveat: t("marketing.arabicSeo.platform.cms.caveat"),
      cms: true,
    },
    {
      name: "Mintlify",
      sources: [
        {
          ...
          label: t("marketing.arabicSeo.source.languages"),
        },
        {
          href: "https://www.mintlify.com/pricing",
          label: t("marketing.arabicSeo.source.pricing"),
        },
      ],
      ...
      sources: [
        {
          ...
          label: t("marketing.arabicSeo.source.officialDocs"),
        },
      ],
      ...
      sources: [
        {
          ...
          label: t("marketing.arabicSeo.source.official"),
        },
      ],
    ...
    <div className="min-h-screen bg-background text-foreground" dir="rtl">
      ...
      <header className="sticky top-0 z-40 border-border/70 border-b bg-background/80 backdrop-blur-xl">
        <div className="mx-auto flex h-16 max-w-6xl items-center gap-3 px-4 sm:px-6">
          ...
          <nav
            aria-label={t("marketing.arabicSeo.shell.navLabel")}
            className="ms-8 hidden items-center gap-6 text-muted-foreground text-sm md:flex"
          >
            ...
            <a className="hover:text-foreground" href="https://docs.cms.com">
        ...
        <div className="mx-auto grid max-w-6xl gap-8 px-6 py-12 text-sm sm:grid-cols-3">
          ...
          <div>
            <p className="font-medium">
              {t("marketing.arabicSeo.shell.usefulLinks")}
            </p>
          ...
          <div>
            <p className="font-medium">
              {t("marketing.arabicSeo.shell.sourceTransparency")}
            </p>
            <div className="mt-3 grid gap-2 text-muted-foreground">
              <a
...
export function ArabicLandingPage() {
  ...
  const features: Array<{ icon: LucideIcon; title: string; body: string }> = [
    {
      icon: Languages,
      title: t("marketing.arabicSeo.landing.featureLanguageTitle"),
      body: t("marketing.arabicSeo.landing.featureLanguageBody"),
    },
    {
      icon: Search,
      title: t("marketing.arabicSeo.landing.featureSearchTitle"),
      body: t("marketing.arabicSeo.landing.featureSearchBody"),
    },
    {
      icon: Server,
      title: t("marketing.arabicSeo.landing.featureHostingTitle"),
      body: t("marketing.arabicSeo.landing.featureHostingBody"),
    },
    {
      icon: ShieldCheck,
      title: t("marketing.arabicSeo.landing.featureOwnershipTitle"),
      body: t("marketing.arabicSeo.landing.featureOwnershipBody"),
    },
  ];
  return (
    <ArabicShell>
        ...
        <div className="mx-auto grid max-w-6xl items-center gap-12 px-6 py-20 lg:grid-cols-[1fr_0.82fr] lg:py-28">
          <div>
            ...
            <p className="mt-6 max-w-2xl text-balance text-lg text-muted-foreground leading-8">
              {t("marketing.arabicSeo.landing.intro")}
            </p>
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              >
                {t("marketing.arabicSeo.cta.createFree")}{" "}
            ...
            <div className="mt-8 flex flex-wrap gap-x-6 gap-y-2 text-muted-foreground text-sm">
              <span className="inline-flex items-center gap-2">
                ...
                {t("marketing.arabicSeo.landing.noCard")}
              </span>
              <span className="inline-flex items-center gap-2">
                <Check className="size-4 text-primary" />{" "}
                {t("marketing.arabicSeo.landing.markdownOwned")}
              </span>
              <span className="inline-flex items-center gap-2">
                <Check className="size-4 text-primary" />{" "}
                {t("marketing.arabicSeo.landing.arabicFirst")}
              </span>
            </div>
          </div>
          <div className="rounded-2xl border border-border bg-card p-6 shadow-2xl shadow-black/5">
            <div className="flex items-center justify-between border-border border-b pb-4 text-sm">
              <span className="font-medium">
                {t("marketing.arabicSeo.landing.demoTitle")}
              </span>
              <span className="rounded-md bg-primary/10 px-2 py-1 text-primary">
                {t("marketing.arabicSeo.landing.demoBadge")}
              </span>
            </div>
            <div className="mt-6 space-y-5">
              <div>
                <p className="text-muted-foreground text-xs">
                  {t("marketing.arabicSeo.landing.demoLabel")}
                </p>
                <p className="mt-1 font-semibold text-xl">
                  {t("marketing.arabicSeo.landing.demoHeading")}
                </p>
              </div>
              ...
              <div className="flex items-center gap-2 text-muted-foreground text-sm">
                ...
                {t("marketing.arabicSeo.landing.demoSearch")}
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="mx-auto max-w-6xl px-6 py-24" id="features">
        <div className="max-w-3xl">
          <p className="font-medium text-primary text-sm">
            {t("marketing.arabicSeo.landing.featuresEyebrow")}
          </p>
          <h2 className="mt-3 font-semibold text-4xl tracking-tight">
            {t("marketing.arabicSeo.landing.featuresHeading")}
          </h2>
          <p className="mt-5 text-lg text-muted-foreground leading-8">
            {t("marketing.arabicSeo.landing.featuresBody")}
          </p>
        </div>
      ...
      <section className="border-border border-y bg-card/50">
        <div className="mx-auto grid max-w-6xl gap-12 px-6 py-24 lg:grid-cols-2">
          <div>
            <p className="font-medium text-primary text-sm">
              {t("marketing.arabicSeo.landing.fitEyebrow")}
            </p>
            <h2 className="mt-3 font-semibold text-3xl tracking-tight">
              {t("marketing.arabicSeo.landing.fitHeading")}
            </h2>
          ...
          <div>
            <p className="font-medium text-primary text-sm">
              {t("marketing.arabicSeo.landing.alternativeEyebrow")}
            </p>
            <h2 className="mt-3 font-semibold text-3xl tracking-tight">
              {t("marketing.arabicSeo.landing.alternativeHeading")}
            </h2>
            <ul className="mt-6 space-y-4 text-muted-foreground leading-7">
              {[
      ...
      <section className="mx-auto max-w-4xl px-6 py-24 text-center">
        <h2 className="text-balance font-semibold text-4xl tracking-tight">
          {t("marketing.arabicSeo.landing.resourceHeading")}
        </h2>
        <p className="mx-auto mt-5 max-w-2xl text-lg text-muted-foreground leading-8">
          {t("marketing.arabicSeo.landing.resourceBody")}
        </p>
        <div className="mt-8 flex flex-wrap justify-center gap-3">
          <a
            ...
            onClick={() =>
              sendMarketingCtaEvent({
                destination: "rtl_tool",
                language: "ar",
                placement: "resource_bridge",
              })
            }
          >
      ...
      <article>
        <header className="border-border border-b">
          <div className="mx-auto max-w-4xl px-6 py-20">
            <p className="font-medium text-primary text-sm">
              {t("marketing.arabicSeo.comparison.eyebrow")}
            </p>
            ...
            <p className="mt-6 text-lg text-muted-foreground leading-8">
              {t("marketing.arabicSeo.comparison.intro")}
            </p>
            <p className="mt-5 border-border border-t pt-5 text-muted-foreground text-sm leading-7">
              {t("marketing.arabicSeo.comparison.disclosure", {
                reviewedOn: t("marketing.arabicSeo.comparison.reviewedOn"),
              })}
            </p>
          </div>
        </header>
        ...
        <section className="mx-auto max-w-4xl px-6 py-16">
          <h2 className="font-semibold text-3xl tracking-tight">
            {t("marketing.arabicSeo.comparison.methodHeading")}
          </h2>
          <p className="mt-5 text-muted-foreground leading-8">
            {t("marketing.arabicSeo.comparison.methodBody")}
          </p>
          <div className="mt-8 overflow-x-auto rounded-xl border border-border bg-card">
            <table className="w-full min-w-[46rem] text-sm">
              <caption className="sr-only">
                {t("marketing.arabicSeo.comparison.tableCaption")}
              </caption>
              <thead>
                <tr className="border-border border-b bg-muted/50">
                  <th className="px-4 py-3 text-start">
                    {t("marketing.arabicSeo.comparison.platform")}
                  </th>
                  <th className="px-4 py-3 text-start">
                    {t("marketing.arabicSeo.comparison.bestFor")}
                  </th>
                  <th className="px-4 py-3 text-start">
                    {t("marketing.arabicSeo.comparison.arabicStatus")}
                  </th>
                  <th className="px-4 py-3 text-start">
                    {t("marketing.arabicSeo.comparison.operatingModel")}
                  </th>
                </tr>
              </thead>
              <tbody>
                {platforms.map((platform) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-4 text-muted-foreground leading-6">
                      {platform.bestFor}
                    </td>
                    <td className="px-4 py-4 text-muted-foreground leading-6">
                      {platform.arabic}
        ...
        <section className="border-border border-y bg-card/40">
          <div className="mx-auto max-w-4xl px-6 py-16">
            <h2 className="font-semibold text-3xl tracking-tight">
              {t("marketing.arabicSeo.comparison.optionsHeading")}
            </h2>
            <div className="mt-10 space-y-6">
              {platforms.map((platform, index) => (
                <section
                  className={`rounded-xl border bg-background p-7 ${platform.cms ? "border-primary/40 ring-1 ring-primary/20" : "border-border"}`}
                  key={platform.name}
                >
                  ...
                  <dl className="mt-5 grid gap-4 text-sm sm:grid-cols-2">
                    <div>
                      <dt className="font-medium">
                        {t("marketing.arabicSeo.comparison.chooseWhen")}
                      </dt>
                    ...
                    <div>
                      <dt className="font-medium">
                        {t("marketing.arabicSeo.comparison.watchFor")}
                      </dt>
                      <dd className="mt-1 text-muted-foreground leading-7">
                        {platform.caveat}
                      </dd>
        ...
        <section className="mx-auto max-w-4xl px-6 py-16">
          <h2 className="font-semibold text-3xl tracking-tight">
            {t("marketing.arabicSeo.comparison.criteriaHeading")}
          </h2>
          <div className="mt-8 grid gap-6 sm:grid-cols-2">
            {[
              [
                t("marketing.arabicSeo.comparison.criteriaMixedTitle"),
                t("marketing.arabicSeo.comparison.criteriaMixedBody"),
              ],
              [
                t("marketing.arabicSeo.comparison.criteriaBlocksTitle"),
                t("marketing.arabicSeo.comparison.criteriaBlocksBody"),
              ],
              [
                t("marketing.arabicSeo.comparison.criteriaWorkflowTitle"),
                t("marketing.arabicSeo.comparison.criteriaWorkflowBody"),
              ],
              [
                t("marketing.arabicSeo.comparison.criteriaOwnershipTitle"),
                t("marketing.arabicSeo.comparison.criteriaOwnershipBody"),
              ],
              [
                t("marketing.arabicSeo.comparison.criteriaCostTitle"),
                t("marketing.arabicSeo.comparison.criteriaCostBody"),
              ],
              [
                t("marketing.arabicSeo.comparison.criteriaRolloutTitle"),
                t("marketing.arabicSeo.comparison.criteriaRolloutBody"),
              ],
            ].map(([title, body]) => (
              <div
                className="rounded-xl border border-border bg-card p-6"
        ...
        <section className="border-border border-y bg-card/40">
          <div className="mx-auto max-w-4xl px-6 py-16">
            <h2 className="font-semibold text-3xl tracking-tight">
              {t("marketing.arabicSeo.comparison.recommendationHeading")}
            </h2>
            <div className="mt-8 space-y-5 text-muted-foreground leading-8">
              ...
              <p>
                <strong className="text-foreground">
                  {t("marketing.arabicSeo.comparison.recommendationAiLabel")}
                </strong>{" "}
              ...
              <p>
                <strong className="text-foreground">
                  {t("marketing.arabicSeo.comparison.recommendationApiLabel")}
                </strong>{" "}
        ...
        <section className="mx-auto max-w-4xl px-6 py-16">
          <h2 className="font-semibold text-3xl tracking-tight">
            {t("marketing.arabicSeo.comparison.faqHeading")}
          </h2>
          <div className="mt-8 divide-y divide-border rounded-xl border border-border bg-card">
            {[
              [
                t("marketing.arabicSeo.comparison.faqAlternativeQuestion"),
                t("marketing.arabicSeo.comparison.faqAlternativeAnswer"),
              ],
              [
                t("marketing.arabicSeo.comparison.faqMintlifyQuestion"),
                t("marketing.arabicSeo.comparison.faqMintlifyAnswer"),
              ],
              [
                t("marketing.arabicSeo.comparison.faqGitbookQuestion"),
                t("marketing.arabicSeo.comparison.faqGitbookAnswer"),
              ],
              [
                t("marketing.arabicSeo.comparison.faqHostingQuestion"),
                t("marketing.arabicSeo.comparison.faqHostingAnswer"),
              ],
              [
                t("marketing.arabicSeo.comparison.faqTranslationQuestion"),
                t("marketing.arabicSeo.comparison.faqTranslationAnswer"),
              ],
            ].map(([question, answer]) => (
              <details
                className="group px-6 py-1 open:bg-muted/30"
                key={question}
              >
                ...
                <p className="pb-5 text-muted-foreground text-sm leading-7">
                  {answer}
                </p>
              </details>
            ))}
        ...
        <section className="mx-auto max-w-5xl px-6 pb-24">
          <div className="rounded-2xl bg-foreground px-8 py-14 text-center text-background">
            <h2 className="font-semibold text-3xl tracking-tight">
              {t("marketing.arabicSeo.comparison.finalHeading")}
            </h2>
            <p className="mx-auto mt-4 max-w-2xl text-background/75 leading-7">
              {t("marketing.arabicSeo.comparison.finalBody")}
            </p>
