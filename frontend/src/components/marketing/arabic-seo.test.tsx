...
import {
  ArabicDocumentationPlatformsPage,
  ArabicLandingPage,
} from "@/components/marketing/arabic-seo";
...
describe("Arabic marketing pages", () => {
  ...
  it("renders a disclosed, source-backed six-platform comparison", () => {
    ...
    expect(html).toContain("الإفصاح: نحن نبني CMS");
    ...
    expect(html).toContain(
      "https://gitbook.com/docs/publishing-documentation/site-structure/variants",
    );
    ...
    expect(html).toContain(
      "https://apidog.com/ar/blog/documentation-tools-ar/",
    );
  });
});
