...
const PAGE_SETTINGS_SECTIONS = [
  {
    id: "general",
    labelKey: "editor.pageSettings.tab.general",
    icon: CirclePlus,
  },
  { id: "seo", labelKey: "editor.pageSettings.tab.seo", icon: SearchCheck },
  {
    id: "behaviour",
    labelKey: "editor.pageSettings.tab.behaviour",
    icon: PanelsTopLeft,
  },
] as const satisfies ReadonlyArray<{
  id: PageSettingsSection;
  labelKey: MessageKey;
  icon: LucideIcon;
}>;
...
export function PageSettingsDialog({
  ...
  const save = () => {
    ...
    const parsedCategoryOrder =
      categoryOrder.trim() === "" ? undefined : Number(categoryOrder);
    ...
    const hasOverride =
      ...
      mode !== "default" ||
      hideToc ||
      [metaTitle, metaDescription, ogImage, canonicalUrl].some(
        (v) => v.trim() !== "",
      ) ||
      noindex;
    update.mutate(
      ...
      },
      {
        ...
        onError: (e) =>
          toast.error(
            e instanceof Error ? e.message : t("editor.pageSettings.saveError"),
          ),
      },
    );
  };
            ...
            <div className="min-h-0 flex-1 overflow-y-auto px-6 py-5">
              {section === "general" ? (
                <div className="flex flex-col gap-4">
                  <Field
                    label={t("editor.pageSettings.pageTitle")}
                    hint={t("editor.pageSettings.pageTitleHint")}
                    htmlFor="page-title"
                  >
                    <Input
                      id="page-title"
                  ...
                  <Field
                    label={t("editor.pageSettings.slug")}
                    hint={t("editor.pageSettings.slugHint")}
                    htmlFor="page-slug"
                  >
                    <Input
                      id="page-slug"
                  ...
                  <Field
                    label={t("editor.pageSettings.sidebarTitle")}
                    hint={t("editor.pageSettings.sidebarTitleHint")}
                    htmlFor="page-sidebar"
                  >
                    <Input
                      id="page-sidebar"
                      value={sidebarTitle}
                  ...
                  <Field
                    label={t("editor.pageSettings.tag")}
                    hint={t("editor.pageSettings.tagHint")}
                    htmlFor="page-tag"
                  >
                    <Input
                      id="page-tag"
                  ...
                  <Field
                    label={t("editor.pageSettings.tags")}
                    hint={t("editor.pageSettings.tagsHint")}
                    htmlFor="page-tags"
                  >
                    <Input
                      id="page-tags"
                  ...
                  <div className="grid grid-cols-[minmax(0,1fr)_8rem] gap-3">
                    <Field
                      label={t("editor.pageSettings.category")}
                      hint={t("editor.pageSettings.categoryHint")}
                    ...
                    <Field
                      label={t("editor.pageSettings.categoryOrder")}
                      htmlFor="page-category-order"
                    >
                      <Input
                  ...
                  <Field
                    label={t("editor.pageSettings.categoryIcon")}
                    hint={t("editor.pageSettings.categoryIconHint")}
                    htmlFor="page-category-icon"
                  >
                    <Input
                      id="page-category-icon"
                      value={categoryIcon}
                  ...
                  <Field
                    label={t("editor.pageSettings.icon")}
                    htmlFor="page-icon"
                  >
                    <Input
                      id="page-icon"
                  ...
                  <Field
                    label={t("editor.pageSettings.description")}
                    htmlFor="page-desc"
                  >
                    <Textarea
                      id="page-desc"
                      ...
                      rows={3}
                      placeholder={t(
                        "editor.pageSettings.descriptionPlaceholder",
                      )}
                    />
                  </Field>
                  <Toggle
              ...
              {section === "seo" ? (
                <div className="flex flex-col gap-4">
                  <Field
                    label={t("editor.pageSettings.metaTitle")}
                    hint={t("editor.pageSettings.metaTitleHint")}
                  ...
                  <Field
                    label={t("editor.pageSettings.ogImage")}
                    hint={t("editor.pageSettings.ogImageHint")}
                    htmlFor="page-og"
                  >
                    <Input
                      id="page-og"
                  ...
                  <Field
                    label={t("editor.pageSettings.canonicalUrl")}
                    hint={t("editor.pageSettings.canonicalUrlHint")}
                    htmlFor="page-canonical"
                  >
                    <Input
                      id="page-canonical"
                      value={canonicalUrl}
              ...
              {section === "behaviour" ? (
                <div className="flex flex-col gap-4">
                  <Field
                    label={t("editor.pageSettings.mode")}
                    hint={t("editor.pageSettings.modeHint")}
                    htmlFor="page-mode"
                  >
                    <Select
                      value={mode}
                      onValueChange={(v) =>
                        setMode((v as PageMode) ?? "default")
                      }
                    >
                      ...
                      <SelectContent>
                        <SelectItem value="default">
                          {t("editor.pageSettings.mode.default")}
                        </SelectItem>
                        <SelectItem value="wide">
                          {t("editor.pageSettings.mode.wide")}
                        </SelectItem>
                        <SelectItem value="center">
                          {t("editor.pageSettings.mode.center")}
                        </SelectItem>
                      </SelectContent>
                    </Select>
                  </Field>
