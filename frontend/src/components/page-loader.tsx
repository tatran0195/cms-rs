...
import { useStandaloneT } from "@cms/i18n/standalone";
  ...
  return (
    ...
    >
      <div className="flex flex-col items-center gap-4">
        <CMSMark className="size-10 animate-pulse text-primary" />
      ...
      <style>
        {
          "@keyframes pl-loading{0%{transform:translateX(-120%)}100%{transform:translateX(360%)}}"
        }
      </style>
    </div>
  );
