  ...
  const saveTranslations = async () => {
    for (const language of extraLanguages) {
      ...
      await updateLanguage.mutateAsync({
        id: language.id,
        body: {
          translation: name || description ? { name, description } : null,
        },
      });
    }
  };
        ...
        <div className="mb-6 border-border border-t pt-5">
          ...
          {extraLanguages.length <= 3 ? (
            <Segmented
              ...
              options={extraLanguages.map((language) => ({
                value: language.id,
            ...
            <div className="mb-4">
              ...
              >
                <SelectTrigger
                  aria-label={t("settings.chrome.scope.label")}
                ...
                return (
                  <div className="grid grid-cols-1 gap-5 p-4 sm:grid-cols-2 sm:gap-6">
                    ...
                    <Field
                      ...
                      label={t("settings.general.translations.name.label")}
                    >
                      <Input
                        className={FIELD_INPUT}
                        id="set-lang-name"
