...
export const AlertDialog = (props: ComponentProps<typeof Dialog>) => (
  <Dialog {...props} modal disablePointerDismissal />
);
...
export const AlertDialogCancel = ({
  ...
  <DialogClose
    render={<Button autoFocus type="button" variant="outline" {...props} />}
  >
    {children}
  </DialogClose>
);

export const AlertDialogAction = (props: ComponentProps<typeof Button>) => (
