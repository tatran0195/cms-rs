...
function ThemeCard({
  ...
  return (
    ...
    >
      <span
        className="block overflow-hidden rounded-lg border p-2.5"
        style={{ background: option.surface, borderColor: option.border }}
      >
        <span
          className="mb-1.5 block h-2 rounded"
          style={{ width: "38%", background: option.bars[0] }}
        />
        <span
          className="mb-1.5 block h-2 rounded"
          style={{ width: "70%", background: option.bars[1] }}
        />
        <span
          className="block h-2 rounded"
          style={{ width: "55%", background: option.bars[2] }}
        />
      </span>
...
export function AppearanceTab() {
  ...
  return (
    <SettingsSection
      title="Theme"
      description="How the CMS dashboard, editor, and settings look for you. This doesn't change your published doc sites."
    >
