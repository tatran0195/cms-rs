...
This guide gives you a production checklist for a Compose-based docs stack. It uses CMS's architecture as the concrete example, including its public repository, pinned container release, and guided installer.

<Callout title="CMS installer">
...
A full documentation platform usually has more state than a static site generator. CMS's Compose design separates six jobs:
...
If engineers alone maintain a small set of Markdown files, a static generator may be simpler. The [CMS and Docusaurus comparison](/compare/cms-vs-docusaurus) explains that trade-off. If the team needs a visual editor today and does not want to operate the stack, [CMS Cloud is in free beta](/pricing).

For CMS specifically, run the [guided installer](/self-hosting) on a disposable server first. Complete this checklist there, including a restore rehearsal, before moving real documentation.
