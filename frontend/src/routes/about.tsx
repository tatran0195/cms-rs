...
export const Route = createFileRoute("/about")({
  ...
  head: () => ({
    meta: pageMeta({
      title: "About CMS: documentation ownership and Arabic support",
      description:
        "Why CMS exists: a Markdown-based, Arabic-ready documentation platform for teams that want portable content and a clear publishing workflow.",
      path: "/about",
    }),
...
const VALUES: {
...
}[] = [
  {
    ...
    body: "The public codebase and container release use AGPL-3.0.",
  },
  {
    icon: BookOpen,
    title: "Portable content",
    body: "Pages are stored as Markdown in the database and can be exported as Markdown.",
  },
  {
    icon: Globe,
    title: "Bilingual by design",
    body: "English and Arabic with full RTL — first-class, not bolted on.",
  },
  {
    icon: Server,
    ...
    <MarketingShell stars={stars}>
      ...
      <section className="border-border border-b">
        <div className="mx-auto max-w-3xl px-6 py-20 text-center">
          ...
          <h1 className="mt-4 text-balance font-semibold text-4xl tracking-tight sm:text-5xl">
            Documentation you own, in every language
          </h1>
      ...
      <section className="mx-auto max-w-3xl px-6 py-20">
        ...
        <div className="mt-6 space-y-5 text-lg text-muted-foreground leading-relaxed">
          <p>
            Great docs tooling had become something you rent. Your content,
            search index, analytics, and readers all lived on someone else's
            servers, behind a per-seat bill. CMS focuses on portable Markdown
            content, a browser editor, and a publishing workflow that teams can
            inspect.
          </p>
          <p>
            It was built Arabic-first — full right-to-left support and bilingual
            authoring are core, not an afterthought — so teams working across
      ...
      <section className="mx-auto max-w-3xl px-6 py-20">
        ...
        <p className="mt-4 text-lg text-muted-foreground leading-relaxed">
          {t("marketing.release.stack")}
        </p>
        <p className="mt-4 text-lg text-muted-foreground leading-relaxed">
          We document those boundaries plainly. Product pages should distinguish
          shipped behavior from planned work, comparisons should point to
          current primary sources, and technical articles should describe what
          the code and tests support today. When a claim changes, we correct the
        ...
        <div className="relative overflow-hidden rounded-2xl border border-border bg-foreground px-8 py-14 text-center text-background">
          ...
          <div className="relative">
            ...
            <p className="mx-auto mt-3 max-w-xl text-background/75">
              Start free on CMS Cloud, or use the public self-hosted release on
