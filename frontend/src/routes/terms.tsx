...
export const Route = createFileRoute("/terms")({
  ...
  head: () => ({
    meta: pageMeta({
      title: "CMS Cloud Terms of Service and Acceptable Use",
      description:
        "Read the terms governing CMS Cloud accounts, acceptable use, subscriptions, content ownership, service availability, and liability.",
      path: "/terms",
    }),
...
const SECTIONS: { heading: string; body: string }[] = [
  {
    ...
    body: 'By accessing or using CMS Cloud or the CMS open-source edition (the "Service") you agree to be bound by these Terms of Service. If you do not agree to these terms, do not use the Service. Teams running their own deployment should review and adapt these terms with their own legal counsel.',
  },
  {
    heading: "2. Free beta",
    body: "CMS Cloud is currently in a free beta. During the beta the Service is provided as-is and as-available: features may change, and while we work hard to keep your content safe and the service up, we do not yet offer uptime or support guarantees. There are no paid plans today. The separately operated self-hosted release is governed by its AGPL-3.0 license and your own infrastructure terms.",
  },
  {
  ...
  {
    heading: "9. Contact",
    body: "Questions about these terms or the Service: support@cms.com. Security vulnerabilities: security@cms.com. Abuse reports: abuse@cms.com.",
  },
];
