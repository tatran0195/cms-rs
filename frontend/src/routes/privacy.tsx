...
export const Route = createFileRoute("/privacy")({
  ...
  head: () => ({
    meta: pageMeta({
      title: "CMS Cloud Privacy Policy and Data Practices",
      description:
        "How CMS Cloud handles account and documentation data, analytics, subprocessors, retention, security, and deletion requests.",
      path: "/privacy",
    }),
...
const SECTIONS: { heading: string; body: string }[] = [
  {
    ...
    body: "For CMS Cloud, your content and account data are used only to provide hosting, publishing, search, analytics, authentication, and support. We do not sell your data or use it for advertising. A separately operated self-hosted deployment is governed by its operator's privacy practices.",
  },
  {
    heading: "2. What we collect",
    body: "We collect the information needed to operate CMS Cloud: account details (name, email, and a hashed password or your Google account identifier), workspace and project metadata, the documentation content you author, published-site analytics, product usage events (such as sign-up, editing, and publishing activity) that we use to operate and improve the service, support communications, and session data — including IP addresses and browser user-agent — used for authentication and to protect accounts against abuse.",
  },
  {
    heading: "3. Where your data lives",
    body: "CMS Cloud is hosted in the European Union. Your account data, documentation content, and uploaded assets are stored on servers located in the EU.",
  },
  {
  ...
  },
  {
    ...
    body: "You can delete projects and workspaces from the dashboard at any time, which removes their content and published sites. To delete your account entirely, or for access, correction, or export requests, email privacy@cms.com and we will action the request. Backups expire on a rolling basis after deletion.",
  },
  {
  ...
  {
    heading: "9. Contact",
    body: "For any privacy question or request, contact privacy@cms.com.",
  },
];
