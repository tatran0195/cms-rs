...
mod tests {
    ...
    fn create_test_auth_service() -> AuthService {
        ...
        let pool = nibleaf_db::PgPool::connect_lazy(&"postgres://user:pass@localhost/db")
    ...
    fn test_api_key_jwt_roundtrip() {
        ...
        let token = JwtService::create_api_key_jwt(
            "key-1",
            "user-1",
            Some("org-1"),
            &auth_service,
