...
pub async fn get_organization_stats_handler(
    ...
    let stats = nibleaf_biz::analytics::AnalyticsService::get_organization_stats(
        &state.biz_context,
        &org_id,
    ).await?;
...
pub async fn get_system_stats_handler(
    ...
    let stats = nibleaf_biz::analytics::AnalyticsService::get_system_stats(
        &state.biz_context,
    ).await?;
...
pub async fn get_system_health_handler(
    ...
    let health = nibleaf_biz::platform_event::PlatformEventService::get_system_health(
        &state.biz_context,
    ).await?;
