...
use utoipa::ToSchema;
use nibleaf_biz::reader_access::ReaderAccessService;
use nibleaf_entity::reader_access::{ReaderResponse, AudienceResponse, AudienceGrantResponse, CreateAudienceRequest, UpdateAudienceRequest, CreateAudienceGrantRequest, ReaderInvitationResponse, CreateReaderInvitationRequest, ReaderSessionResponse};
...
pub async fn create_reader_invitation_handler(
    ...
    let invitation = ReaderAccessService::create_reader_invitation(
        ...
        &auth.user.id,
        &request.audience_id,
        nibleaf_entity::reader_access::CreateInvitationRequest {
            email: request.email,
