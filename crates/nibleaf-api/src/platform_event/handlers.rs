...
use utoipa::ToSchema;
use nibleaf_biz::platform_event::PlatformEventService;
use nibleaf_entity::platform_event::{PlatformEventResponse, ListPlatformEventsQuery};
...
pub async fn create_platform_event_handler(
    ...
    let event = PlatformEventService::create_event(
        ...
        user_id.as_deref(),
        nibleaf_entity::platform_event::CreatePlatformEventRequest {
