...
use utoipa::ToSchema;
use nibleaf_biz::project::ProjectService;
use nibleaf_entity::project::{CreateProjectRequest, UpdateProjectRequest, ProjectWithOrgResponse, ProjectResponse, ListProjectsQuery, ListProjectsResponse, ProjectSettings, UpdateProjectSettingsRequest};
...
pub async fn list_project_addons_handler(
    ...
    auth: AuthExtractor,
    Path(project_id): Path<Id>,
) -> Result<Json<Vec<nibleaf_entity::project::ProjectAddonResponse>>, AppError> {
