//! Nibleaf Configuration
//!
//! This crate provides typed configuration for the Nibleaf application,
//! following AppFlowy's pattern of a single Config struct with env-file split
//! for dev vs. deploy.
//!
//! Configuration is loaded from:
//! - Environment variables (prefixed with NIBLEAF_)
...
/// Main configuration struct for the Nibleaf application
...
fn default_trusted_proxy_hops() -> usize { 1 }
...
fn default_database_url() -> String { "postgres://postgres:postgres@localhost:5432/nibleaf".to_string() }
fn default_max_pool_size() -> u32 { 20 }
...
fn default_search_backend() -> String { "pgvector".to_string() }
...
fn default_queue_backend() -> String { "memory".to_string() }
fn default_queue_workers() -> usize { 4 }
...
fn default_analytics_backend() -> String { "postgres".to_string() }
...
fn default_session_secret() -> String { "dev_session_secret_change_in_production".to_string() }
fn default_jwt_secret() -> String { "dev_jwt_secret_change_in_production".to_string() }
fn default_session_expiration() -> i64 { 24 * 7 } // 7 days
fn default_jwt_expiration() -> i64 { 24 * 30 } // 30 days
fn default_api_key_prefix() -> String { "nibleaf_api_key".to_string() }
...
pub struct SiteConfig {
    /// Marketing brand host (e.g., nibleaf.com)
    #[serde(default)]
...
fn default_seo_cache_max_age() -> usize { 300 } // 5 minutes
...
fn default_mcp_max_connections() -> usize { 100 }
fn default_mcp_rate_limit() -> usize { 60 }
...
fn default_rate_limit_max_clients() -> usize { 10_000 }
fn default_rate_limit_ttl() -> u64 { 300 } // 5 minutes
...
fn default_security_headers_hsts() -> bool { true }
fn default_security_headers_hsts_max_age() -> u32 { 31536000 } // 1 year
fn default_security_headers_hsts_include_subdomains() -> bool { true }
fn default_security_headers_x_content_type() -> bool { true }
fn default_security_headers_x_frame() -> bool { true }
fn default_security_headers_x_frame_options() -> String { "DENY".to_string() }
fn default_security_headers_x_xss() -> bool { true }
fn default_security_headers_csp() -> bool { true }
...
fn default_security_headers_referrer() -> bool { true }
fn default_security_headers_referrer_policy() -> String { "strict-origin-when-cross-origin".to_string() }
fn default_security_headers_permissions() -> bool { true }
...
fn default_admin_origin_origins() -> Vec<String> {
    vec![
        "https://admin.nibleaf.com".to_string(),
        "https://app.nibleaf.com".to_string(),
        "https://nibleaf.com".to_string(),
    ]
}

fn default_admin_origin_enforce() -> bool { true }
fn default_admin_origin_localhost() -> bool { true }
...
impl Config {
    ...
    /// 3. Environment variables (NIBLEAF_ prefix)
    pub fn load() -> Result<Self, anyhow::Error> {
        let env = std::env::var("NIBLEAF_ENV").unwrap_or_else(|_| "dev".to_string());
        ...
        // Load from environment variables with NIBLEAF_ prefix
        builder = builder.add_source(
            Environment::with_prefix("NIBLEAF")
                .prefix_separator("_")
                .separator("__")
        );
