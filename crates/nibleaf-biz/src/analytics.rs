...
use nibleaf_db::analytics::AnalyticsEventQueries;
use nibleaf_entity::analytics::{AnalyticsEvent, AnalyticsEventResponse, AnalyticsQueryRequest, AnalyticsQueryResponse, AnalyticsResultItem};
...
impl AnalyticsService {
    ...
    pub async fn track_event(
        ctx: &BizContext,
        request: nibleaf_entity::analytics::TrackAnalyticsEventRequest,
    ) -> Result<AnalyticsEventResponse, AppError> {
        Self::record_event(
            ctx,
    ...
    pub async fn list_events(
        ctx: &BizContext,
        user_id: &str,
        query: nibleaf_entity::analytics::ListAnalyticsEventsQuery,
    ) -> Result<nibleaf_entity::common::PaginatedResponse<AnalyticsEventResponse>, AppError> {
    ...
    pub async fn get_dashboard(
        ...
        _user_id: &str,
        _project_id: &str,
    ) -> Result<nibleaf_entity::analytics::AnalyticsDashboardResponse, AppError> {
        Ok(nibleaf_entity::analytics::AnalyticsDashboardResponse {
            total_events: 0,
