...
use nibleaf_db::project::{ProjectQueries, ProjectSettingsQueries, ProjectAddonQueries};
use nibleaf_db::org::MemberQueries;
use nibleaf_entity::project::{
...
use nibleaf_entity::org::OrganizationResponse;
...
impl ProjectService {
    ...
    pub async fn create_project(
        ...
        let org = nibleaf_db::org::OrganizationQueries::get_by_id(&ctx.pool, org_id)
            .await?
    ...
    pub async fn get_project(
        ...
        let org = nibleaf_db::org::OrganizationQueries::get_by_id(
            &ctx.pool,
    ...
    pub async fn get_public_project(
        ...
        let org = nibleaf_db::org::OrganizationQueries::get_by_slug(&ctx.pool, org_slug)
            .await?
            .ok_or_else(|| AppError::NotFound("Organization not found".to_string()))?;
