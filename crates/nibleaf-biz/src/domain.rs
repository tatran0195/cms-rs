...
use nibleaf_entity::common::{Id, MemberRole};
...
impl DomainService {
    ...
    pub async fn verify_domain_ownership(
        ...
        let deployment = nibleaf_db::deployment::DeploymentQueries::get_by_id(
            &ctx.pool,
    ...
    pub async fn create_domain(
        ctx: &BizContext,
        user_id: &str,
        request: nibleaf_entity::domain::CreateDomainRequest,
    ...
    pub async fn update_domain(
        ...
        user_id: &str,
        domain_id: &str,
        request: nibleaf_entity::domain::UpdateDomainRequest,
    ) -> Result<DomainResponse, AppError> {
    ...
    pub async fn verify_domain(
        ...
        domain_id: &str,
        verification_token: &str,
    ) -> Result<nibleaf_entity::domain::DomainVerificationResult, AppError> {
        ...
        Ok(nibleaf_entity::domain::DomainVerificationResult {
    ...
    pub async fn set_primary_domain(
        ...
        let deployment = nibleaf_db::deployment::DeploymentQueries::get_by_id(&ctx.pool, deployment_id)
            .await?
            .ok_or_else(|| AppError::NotFound("Deployment not found".to_string()))?;
        ctx.access_control.require_project_role(
            user_id,
