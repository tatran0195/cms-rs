...
use nibleaf_entity::project::{Project, ProjectResponse, ProjectSettings, ProjectAddon, ProjectAddonResponse};
...
impl ProjectQueries {
    ...
    pub async fn get_by_organizations(
        ...
        limit: Option<i64>,
        offset: Option<i64>,
    ) -> Result<Vec<nibleaf_entity::project::Project>, AppError> {
