...
use nibleaf_entity::analytics::AnalyticsEvent;
...
impl AnalyticsEventQueries {
    ...
    ) -> Result<nibleaf_entity::analytics::AnalyticsEvent, AppError> {
...
impl From<AnalyticsEventRow> for nibleaf_entity::analytics::AnalyticsEvent {
