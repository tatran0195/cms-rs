...
use cms_entity::search::{SearchRequest, SearchResponse, SearchResultItem, IndexPageRequest, SearchOptions};
...
impl SearchService {
    ...
    ) -> Result<cms_entity::common::PaginatedResponse<cms_entity::search::SearchIndexRunResponse>, AppError> {
